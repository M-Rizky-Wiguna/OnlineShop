...
const CardList = [
  {
    ...
    FooterCard:
      "Bahan dipilih tim profesional kami lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod.",
  },
  {
    id: 2,
    image: "💰",
    ...
    FooterCard:
      "Harga Bisa Nego lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod.",
  },
  {
    id: 3,
    image: "🏫",
...
<template>
  <main>
    ...
    <div
      class="flex text-center shadow-md bg-slate-950 gap-4 p-20 justify-center h-90 mb-9"
    >
      <div
        v-for="data in CardList"
        :key="data.id"
